...
def generate_installation_method(pv_kw, num_panels, battery_kwh, num_batteries, inverter_kw):
    ...
    # -----------------------------------------------------------------------
    # ITEM 1 — SOLAR PV MODULES
    # -----------------------------------------------------------------------
    lines += [
        L,
        "  ITEM 1 — SOLAR PV MODULES (400 Wp EACH)",
        L,
        "",
        "  NARRATIVE",
        "  " + s,
...
<section id="overview">
  ...
  <strong>{pv_kw:.2f} kWp</strong> off-grid solar PV system — from the PV array
  ...
  <figure class="diagram">
    ...
    sec1 = section(
        "item1", f"Item 1 — Solar PV Modules ({num_panels} × 400 Wp)",
...
<section id="region">
  ...
  justify the selection of an off-grid / hybrid solar PV system as the primary
...
<title>Installation Method Report — Solar PV Off-Grid System</title>
<style>{CSS}</style>
</head>
<body>
<header>
  ...
  <div class="meta">
    Solar PV Off-Grid System &nbsp;|&nbsp; {region_name}, Ghana<br>
...
<footer>
  <p>Generated by Solar PV Designer Lite &nbsp;·&nbsp; Ghana Off-Grid System &nbsp;·&nbsp; BS 7671:2018</p>
</footer>
</body>
</html>"""
