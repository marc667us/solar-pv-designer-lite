...
MATERIALS: dict[str, dict[str, Any]] = {
    "pv_glass":       {"color": "#0b1a3a", "roughness": 0.08, "metalness": 0.0},
    ...
    "soil":           {"color": "#3f6f28", "roughness": 1.00, "metalness": 0.00},
...
def camera_presets(land_side_m: float) -> dict[str, dict[str, Any]]:
    ...
    return {
        ...
        "drone":       {"position": [s * 0.28, s * 0.42, s * 0.85], "target": [0, 6, s * 0.30],
                        "fov": 50, "label": "Drone"},
        ...
        "investor":    {"position": [s * 0.34, s * 0.40, s * 0.92], "target": [0, 6, s * 0.28],
                        "fov": 46, "label": "Investor aerial"},
