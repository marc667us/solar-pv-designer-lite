# patch_product_doc_redirect_splice.py
from pathlib import Path

ROOT = Path(__file__).parent
TARGET = ROOT / "web_app.py"
NEW = ROOT / "new_product_doc_redirect.py"

data = TARGET.read_bytes()
new_code = NEW.read_bytes().replace(b"\r\n", b"\n").replace(b"\n", b"\r\n")

MARKER = b"# === BEGIN: product_doc_redirect splice ==="
END = b"# === END: product_doc_redirect splice ==="
