...
"""
    ...
    for m, kwh in monthly:
        ...
        md += f"| {m} | {kwh} | {sym} {saving} |\n"
    md += f"| **Annual Total** | **{_fmt(annual_gen,0)}** | **{sym} {_fmt(eco.get('annual_sav',0),0)}** |\n"
...
**Phase 5 — Earthing & Bonding:** Drive copper earth rod â‰¥2.4m. Bond all metalwork to earth bar. Test electrode resistance â‰¤10Î©. (BS 7430)

**Phase 6 — Pre-commissioning Tests:** Insulation resistance (â‰¥1MÎ©), continuity, polarity, earth fault loop impedance. All results documented.

**Phase 7 — System Commissioning:** Power up inverter. Test all protection devices — RCD trip â‰¤40ms, MCB overload, SPD. Verify MPPT and battery charging.
