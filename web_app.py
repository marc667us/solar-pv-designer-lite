...
def assistant_chat():
    ...
    _KB = [
        (["load","appliance","watt","consumption","kw","kwh"],
        ...
        (["location","country","region","irradiance","solar resource","tariff"],
        ...
        (["plan","upgrade","professional","enterprise","subscription","limit","feature"],
        ...
        (["payment","momo","mobile money","mtn","paystack","stripe","pay","billing","invoice"],
        ...
        (["economic","npv","irr","payback","dscr","loan","financ","25 year","analysis"],
        ...
        (["cable","wiring","bs 7671","iec","standard","current","voltage drop"],
